...
if (${FLUTTER})
    ...
    # Disable libc++ availability checks — std::optional::value() is marked unavailable on iOS < 12
    # but we target iOS 13+. Without this flag, Xcode SDK headers refuse to compile it.
